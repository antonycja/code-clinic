...
class TestVolunteerFunctions(unittest.TestCase):
    ...
    def test_create_volunteer_slot(self):
        ...
        cancel_event(self.creds, self.starttime, self.endtime,self.volunteer_email, self.calendar_id)

        message = create_volunteer_slot(self.creds, self.volunteer_email, self.starttime, self.endtime, self.campus, self.calendar_id)
    ...
    def test_cancel_event(self):
        ...
        create_volunteer_slot(self.creds, self.volunteer_email, self.starttime, self.endtime, self.campus, self.calendar_id)

        message = cancel_event(self.creds, self.starttime, self.endtime,self.volunteer_email, self.calendar_id)
